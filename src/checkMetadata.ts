...
export async function checkMetadata(file: fs.PathLike): Promise<Message> {
  ...
  // ⚡ Bolt Optimization: Run URL accessibility checks concurrently using Promise.all
  // This reduces the maximum network delay by half since both requests run in parallel
